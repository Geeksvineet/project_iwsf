...
if (isset($_GET['id'])) {
    ...
    // Fetch category data
    $sql = "SELECT * FROM category_causes WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update the category
    $sql = "UPDATE category_causes SET name = '$name', description = '$description' WHERE id = $id";
    if (mysqli_query($conn, $sql)) {
        header("Location: causes_category_control.php");
    } else {
...
<head>
    ...
    <title>Edit causes Category</title>
<?php  
        ...
        ?>
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                        <h2 class="text-dark font-weight-bold mb-2 card-title">Edit causes Category</h2>
