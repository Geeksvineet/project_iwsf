...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update the category
    $sql = "UPDATE category_posts SET name = '$name', description = '$description' WHERE id = $id";
...
<head>
    ...
    <title>Edit Blogs Category</title>
<?php  
        ...
        ?>
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                        <h2 class="text-dark font-weight-bold mb-2 card-title">Edit Blogs Category</h2>
