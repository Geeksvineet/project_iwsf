        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="text-dark font-weight-bold mb-2 card-title">Volunteers Management</h2>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<a href='delete_volunteer_action.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete</a>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                    } else {
