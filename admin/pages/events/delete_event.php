...
$sql = "SELECT events.id, events.title, category_events.name as category 
        FROM events 
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="text-dark font-weight-bold mb-2 card-title">Delete Events</h2>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td><a href='delete_event_action.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete Blog</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
