...
<script>
    ...
    var categoryChart = new Chart(ctx, {
        ...
        data: {
            labels: [
                <?php while ($category = mysqli_fetch_assoc($categoryDistributionResult)) {
                    echo '"' . $category['name'] . '",';
                } ?>
            ],
            datasets: [{
                ...
                data: [
                    <?php mysqli_data_seek($categoryDistributionResult, 0);
                    while ($category = mysqli_fetch_assoc($categoryDistributionResult)) {
                        echo $category['count'] . ',';
                    } ?>
                ],
