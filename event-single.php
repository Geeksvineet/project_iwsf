        ...
        <div class="row clearfix">
          ...
          <div class="content-side col-lg-8 col-md-12 col-sm-12">
            ...
            <div class="event-details">
              <div class="inner-box">
                <div class="image-box">
                  <figure class="image"><img class="lazy-image" src="admin/pages/events/<?= $event['img_path'] ?>" alt="event"></figure>
                  <!-- <div class="date">25 <span class="month">Aug</span></div> -->
                  <div class="date"><?= date("d", strtotime($event['date_of_event_organize'])) ?><span class="month"><?= date(" M", strtotime($event['date_of_event_organize'])) ?></span></div>
                </div>
