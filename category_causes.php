...
//if input is there
if((isset($_GET['id']))){
    $search=filter_var($_GET['id'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $query="SELECT * FROM causes WHERE category_causes_id = $search AND status = 1 ORDER BY date_published DESC";
...
$query1 = "SELECT * FROM causes where status = 1 ORDER BY date_published DESC LIMIT 3";
...
<body>
  ...
  <div class="page-wrapper">
              ...
              <nav class="main-menu navbar-expand-md navbar-light">
                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                  <ul class="navigation clearfix">
                    ...
                    <li class="current"><a href="causes.php">Causes</a>
                    </li>
    ...
    <section class="page-banner">
      <div class="image-layer lazy-image" data-bg="url('images/background/Group 11.jpg')"></div>
    ...
    <div id="cause-area" class="sidebar-page-container">
      <div class="auto-container">
                ...
                <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                  ...
                  <div class="news-block col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box" style="height: 500px; display: flex; flex-direction: column; justify-content: space-between;">
                      <div class="image-box">
                        <figure class="image"><a href="cause-single.php?id=<?= $post['id'] ?>"><img class="lazy-image" src="admin/pages/causes/<?= $post['img_path'] ?>" alt="don"></a></figure>
                      </div>
          ...
          <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
            <aside class="sidebar">
              ...
              <div class="sidebar-widget search-box">
                ...
                <form action="search_causes.php#cause-area" method="GET">
                  <div class="form-group">
              ...
              <div class="sidebar-widget categories">
                ...
                <?php
                $all_categories_query = "SELECT * FROM category_causes";
                ...
                <div class="widget-content">
                  <?php while ($category = mysqli_fetch_assoc($all_categories_result)) : ?>
                    <ul>
                      <li><a href="category_causes.php?id=<?= $category['id'] ?>"><?= $category['name'] ?></a></li>
                    </ul>
                  <?php endwhile ?>
                </div>
              </div>
              ...
              <div class="sidebar-widget popular-posts">
                <h3 class="sidebar-title">Latest Causes</h3>
                <div class="widget-content">

                  <?php while ($post = mysqli_fetch_assoc($result1)) : ?>
                    <!--News Post-->
                    <div class="news-post">
                      <div class="post-thumb"><a href="cause-single.php?id=<?= $post['id'] ?>"><img class="lazy-image" src="admin/pages/causes/<?= $post['img_path'] ?>" alt="img"></a></div>
                      <!-- <div class="date"><span class="fa fa-calendar-alt"></span> <?= date("M d, Y - H:i", strtotime($post['date_published'])) ?></div> -->
                      <h4><a href="cause-single.php?id=<?= $post['id'] ?>"><?= $post['title'] ?> </a></h4>
                    </div>
                  <?php endwhile; ?>
