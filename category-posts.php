...
if((isset($_GET['id']))){
    ...
    $query="SELECT * FROM posts WHERE category_posts_id = $search AND status = 1 ORDER BY date_published DESC";
...
<body>
  ...
  <div class="page-wrapper">
    ...
    <div id="blog-area" class="sidebar-page-container">
      <div class="auto-container">
                      ...
                      <div style="padding: 0 35px 30px;">
                        <div class="post-meta">
                          <ul class="clearfix">
                            ...
                            <li><a href="#"><span class="icon fa fa-comments"><span style="margin-left: 6px;"><?php echo $row_cnt; ?> Comment</span></span></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
