...
<!-- Mirrored from html.commonsupport.xyz/2019/loveus/donate.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Aug 2024 10:18:19 GMT -->
...
<div class="page-wrapper">
    ...
    <section class="page-banner">
        <div class="image-layer lazy-image" data-bg="url('images/background/Group 10.jpg')"></div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="title-column col-lg-6 col-md-12 col-sm-12">
                    	<div class="inner">
                            ...
                            <div class="text">By supporting our cause, you're directly impacting the lives of vulnerable communities. Your generosity enables us to continue our work in providing vital services, from food distribution to social welfare programs. Together, we can make a difference.</div>
                            <figure class="image-box"><img class="lazy-image" src="images/resource/donation.jpg" alt=""></figure>
                        </div>
                    </div>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="select-amount clearfix">
                                            <div class="select-box"><input type="radio" name="payment-group" id="radio-one"><label for="radio-one">₹100</label></div>
                                            <div class="select-box"><input type="radio" name="payment-group" id="radio-two"><label for="radio-two">₹200</label></div>
                                            <div class="select-box"><input type="radio" name="payment-group" id="radio-three" checked><label for="radio-three">₹500</label></div>
                                            <div class="select-box"><input type="radio" name="payment-group" id="radio-four"><label for="radio-four">₹1000</label></div>
                                        </div>
                                    ...
                                    <!-- <div class="method">
                                        ...
                                        <div class="form-group">
                                            <div class="clearfix">
                                            	<div class="radio-block"><input type="radio" id="radio-1" name="method"><label for="radio-1">Online Donation</label></div>
