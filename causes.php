...
$query = "SELECT * FROM causes where status = 1 ORDER BY date_published DESC LIMIT 8";
...
<!-- Mirrored from html.commonsupport.xyz/2019/loveus/causes.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Aug 2024 10:18:19 GMT -->
<!-- Added by HTTrack -->
        ...
        <?php while ($post = mysqli_fetch_assoc($result)) : ?>
          ...
          <div class="cause-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInUp" style="height: 500px; display: flex; flex-direction: column; justify-content: space-between;" data-wow-delay="0ms">
              <div class="image-box">
              <figure class="image"><a href="cause-single.php?id=<?= $post['id'] ?>"><img style="height: 220px;" class="lazy-image" src="admin/pages/causes/<?= $post['img_path'] ?>" alt="don"></a></figure>
              </div>
