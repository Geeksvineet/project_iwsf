...
<!-- Mirrored from html.commonsupport.xyz/2019/loveus/cause-single.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Aug 2024 10:18:19 GMT -->
<!-- Added by HTTrack -->
        ...
        <div class="row clearfix">
          ...
          <div class="content-side col-lg-8 col-md-12 col-sm-12">
            ...
            <div class="cause-details">
              <div class="inner-box">
                <div class="image-box">
                  <figure class="image"><img class="lazy-image" src="admin/pages/causes/<?= $post['img_path'] ?>" alt="cause"></figure>
                </div>
                <div class="lower-content">
                  ...
                  <div class="link-box"><a href="donate.php" class="theme-btn btn-style-one"><span class="btn-title">Donate Now</span></a></div>
                </div>
              </div>
            </div>
